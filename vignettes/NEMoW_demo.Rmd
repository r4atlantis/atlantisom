...
csl: cjfas.csl
vignette: >
  %\VignetteIndexEntry{atlantisom demo notebook}
...
```{r get_names, eval = FALSE, message=FALSE, warning=FALSE}
...
```{r sardine-survey-spec, eval = FALSE}
...
```{r toSS-surveyts-comps, eval= FALSE}
...
```{r toSS-fisherycomps, eval = FALSE}
